...
THREE.OrbitControls = function ( object, domElement ) {
	...
	var mouseMoving = false; //To figure out if the mouse was moving
	var mousePosition = []; //Because Chrome messes up mouse events
	...
	function onMouseMove( event ) {
		...
		if (event.pageX != mousePosition[0] || event.pageY != mousePosition[1]) { //For chrome (because bug), check mouse position against position when clicked
